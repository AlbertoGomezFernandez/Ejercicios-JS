...
const updateFinalPrice = (array) => {

  const updateFinalPrice = array.basePrice + globalBasePrice;

  return array.finalPrice = updateFinalPrice;
};

updateFinalPrice(car1);
updateFinalPrice(car2);
